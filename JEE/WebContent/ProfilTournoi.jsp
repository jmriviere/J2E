				...
				<div class="templatemo_post_mid">
					<ul>
						<li>Manager : <a
							...
							id="lien_compte"><%= t_act.getManager().getLogin() + " de l'�quipe " + t_act.getManager().getEquipe().getName() %></a>
						</li>
						<% if(t_act.getNombre_max_equipes()!=-1) { %>
						<li>Nombre maximum d'�quipes : <%= t_act.getNombre_max_equipes().toString() %></li>
						<% } %>
						<% 
		...
		<div id="templatemo_right_section">
			<div class="templatemo_section_box">
				<div class="templatemo_section_box_top">
					<h1>Liste des �quipes participantes</h1>
				</div>

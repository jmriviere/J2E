...
<!-- page accessible uniquement accessible si non connect� -->
              ...
              <div id="register_box" class="register_form">
                <form  action="TournoiServlet" autocomplete="on" method="post"> 
                  ...
                  <% 
                  	if (name_taken != null) {
                  		if(name_taken) {
                  			out.println("<font color=\"red\"> Nom de tournoi d�j� utilis� </font>");    
                  		}
                  	}
                  %><br/>
                
                  <label for="nbeqsignup" class="younbeq" data-icon="e" >Nombre maximum d'�quipes</label><br/>
                  ...
                  <input type="submit" value="Cr�ation du Tournoi"/> 
                  </p>
                </form> 
              </div>
